...
class User_Submitted_Reps extends StatefulWidget {
  const User_Submitted_Reps({super.key});

  @override
  State<User_Submitted_Reps> createState() => _User_Submitted_RepsState();
}

class _User_Submitted_RepsState extends State<User_Submitted_Reps> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder(
          stream: repData.submittedReps(current_user!.email!),
