...
class Completed_Reps extends StatefulWidget {
  const Completed_Reps({super.key});

  @override
  State<Completed_Reps> createState() => _Completed_RepsState();
}

class _Completed_RepsState extends State<Completed_Reps> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: repData.CompletedReports(current_employee!.email!),
