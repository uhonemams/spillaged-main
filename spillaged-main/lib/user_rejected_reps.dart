...
class User_Rejected_Reps extends StatefulWidget {
  const User_Rejected_Reps({super.key});

  @override
  State<User_Rejected_Reps> createState() => _User_Rejected_RepsState();
}

class _User_Rejected_RepsState extends State<User_Rejected_Reps> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder(
          stream: repData.rejectedReps(current_user!.email!),
