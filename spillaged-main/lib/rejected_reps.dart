...
class Rejected_Reps extends StatefulWidget {
  const Rejected_Reps({super.key});

  @override
  State<Rejected_Reps> createState() => _Rejected_RepsState();
}

class _Rejected_RepsState extends State<Rejected_Reps> {
  ...
  String? step = "maintenance guys assigned";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder(
        stream: repData.rejectedReports(current_employee!.email!),
                                ...
                                Row(
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          color: report_status == "In Progress"
